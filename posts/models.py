...
class Post(models.Model):
    ...
    cover_html=models.ImageField(editable=False)
    ...
    class Meta:
        ...
        unique_together = [['user','message'],['user','cover']] #Every message is uniquely linkd to the user
